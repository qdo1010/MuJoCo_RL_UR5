#!/usr/bin/env python3
"""
Example script to show the UR5 gripper simulation in 3D MuJoCo viewer.
This will display the actual robot simulation, not just camera observations.
"""
...
def main():
    print("=" * 60)
    print("UR5 Gripper 3D Simulation Viewer")
    print("=" * 60)
    ...
    # Get the unwrapped environment to access the controller directly
