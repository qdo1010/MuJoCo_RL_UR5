#!/usr/bin/env python3
"""
Example to show ONLY the 3D viewer (no camera observations to avoid OpenCV conflicts).
...
def main():
    print("=" * 60)
    print("UR5 Gripper 3D Simulation (3D Viewer Only)")
    print("=" * 60)
    print("Note: This script must be run with 'mjpython' on macOS")
    print("You should see a 3D MuJoCo viewer window showing the UR5 robot")
    print("=" * 60)
    
    # Create environment with 3D viewer but NO camera observations
    ...
    try:
        ...
        # Show observation information (but don't display the images)
